export const profile = {
  skills: [
    {
      id: 1,
      text: 'Tengo conocimientos en lenguajes de programación como Golang (librerías estándar, http/net) para la creación de API REST Básicas.',
    },
    {
      id: 2,
      text: 'Conocimientos en Python para la creación de aplicaciones web usando Flask, patrón de arquitectura MVC. Python fue unos de los lenguajes donde mas me apoye en mi etapa de universidad para desarrollar utilidades de uso personal para química, estadística.',
    },
    {
      id: 3,
      text: 'Experiencia en desarrollo web en el Frontend con React JS, Tailwind, CSS, HTML, JavaScript, TypeScript, ViteJS, NextJS, Client Components y Server Components.',
    },
    {
      id: 4,
      text: 'Conocimientos en Backend para el desarrollo de API REST con NodeJS usando express.',
    },
    {
      id: 5,
    ...
    {
      id: 6,
      text: 'conocimientos en base de datos relacionales con PostgreSQL, gestionando conexiones y querys con node-postgres o usando el ORM prisma',
    },
  ],
  description: [
    {
    ...
    {
      id: 2,
      text: 'Tengo experiencia en trabajar en equipo con personas de diferentes partes de mi país. A lo largo de mi carrera, he colaborado con equipos distribuidos geográficamente, lo que me ha permitido desarrollar habilidades de comunicación efectiva y adaptabilidad. Esta experiencia me ha enseñado la importancia de la colaboración y la coordinación en entornos de trabajo remotos, así como la capacidad de trabajar de manera efectiva con personas de diferentes regiones y con diferente culturas o costumbres.',
    },
    {
      id: 3,
