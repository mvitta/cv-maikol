export default function Cv(props: React.ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <g id='SVGRepo_iconCarrier' className='fill-white dark:fill-blue-500'>
        <g id='Layer_1'>
          <circle
